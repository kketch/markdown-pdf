...
module.exports = function (filePaths, opts, cb) {
  ...
  opts.highlight = opts.hightight == void 0 ? true : opts.highlight
    ...
    fs.stat(filePath, function (er, stats) {
      ...
      fs.readFile(filePath, {encoding: 'utf-8'}, function (er, data) {
        ...
        if (opts.highlight) {
            ...
            markedOpts.highlight = function (code, lang, cb) {
                
                var pygmentsOpts = {format: 'html'}
                
                if (lang) {
                    
                    pygmentsOpts.lang = lang;
                    
                } else {
                    
                    pygmentsOpts.guess = true;
                    
                }
                
                pygmentize(pygmentsOpts, code, function (er, html) {
        ...
        // Convert to HTML
        marked(data, markedOpts, function (er, html) {
